  ...
  return (
    <div className="min-h-screen bg-[var(--bg-default)] transition-colors duration-200">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-[var(--border-light)]">
        <h1 className="text-[var(--font-xl)] font-semibold text-[var(--text-heading)] m-0">100 CITY</h1>
        <ThemeToggle />
      </header>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div key={item.label} className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-[var(--radius-md)] shrink-0" style={{ backgroundColor: item.color }} />
